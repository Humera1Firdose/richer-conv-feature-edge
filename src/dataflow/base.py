...
class DataFlow(RNGDataFlow):
    def __init__(self,
        ...
        data_dir_list = utils.make_list(data_dir_list)
        ...
        utils.assert_len([data_name_list, load_fnc_list, data_dir_list])
    ...
    def _load_file_list(self, data_name_list):
        ...
        for data_name, data_dir in zip(data_name_list, self._data_dir_list):
